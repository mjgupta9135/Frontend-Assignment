        ...
        <div className="options">
          ...
          <div className="main-menu">
            ...
            <li className="list_item">
              <img
                className="list_icon"
                src="./dashboard_svg/recruitment.svg"
              />
              <a href="/recruitment">
                <text className="list_opt">Recruitment</text>
              </a>
            </li>
            <li className="list_item">
              <img className="list_icon" src="./dashboard_svg/schedule.svg" />
              <a href="/schedule">
                <text className="list_opt">Schedule</text>
              </a>
            </li>
            <li className="list_item">
              <img className="list_icon" src="./dashboard_svg/employee.svg" />
              <a href="/employee">
                <text className="list_opt">Employee</text>
              </a>
            </li>
            <li className="list_item">
              <img className="list_icon" src="./dashboard_svg/department.svg" />
              <a href="/department">
                <text className="list_opt Dept">Department</text>
              </a>
            </li>
          </div>
          ...
          <div className="next-menu">
            <li className="list_item">
              ...
              <a href="support">
                <text className="list_opt Supp">Support</text>
              </a>
            </li>
            <li className="list_item">
              <img className="list_icon" src="./menu_items/settings.svg" />
              <a href="settings">
                <text className="list_opt Set">Settings</text>
              </a>
            </li>
          </div>
        </div>
